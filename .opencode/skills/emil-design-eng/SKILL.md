...
description: Use when building or reviewing UI components, animations, transitions, or any frontend polish. Reviews code using Before/After tables, catches animation mistakes (ease-in, scale(0), transition-all), and applies rules for easing, duration, stagger, and perceived performance. Based on Emil Kowalski's design engineering philosophy from animations.dev.
---
